...
const ALL_STEPS = [
  {
    ...
    info: "This is what your patients see on their phone after scanning the QR code or using the clinic tablet, which you get per location after signing up. Selecting a language makes the AI chat in that language, but the doctor still sees everything in their preferred language.",
  ...
  },
  {
    ...
    info: "This triggers the AI pre screening conversation. Returning patients are automatically identified by name and date of birth. You can edit their info, skip or switch the AI before approving. Check in flow is configurable per location: Approve to start (current), Approve on arrival (can chat before arrival), or Self service on arrival (entered into queue once patient confirms arrival after chat). You can also share a check in link that sets its own check in configuration for the patient that clicks it.",
    featureGate: null,
    mapsToDemoStep: 2,
  },
  {
  ...
  },
  {
    ...
    todo: "Go to the doctor tab, then click the pulsing Complete button to enter a diagnosis and set a follow up.",
    info: "The AI generates a summary, full transcript, and diagnostic suggestions. Click Scribe when the patient walks in to record your conversation. All this information is used to draft the paperwork for you to review and sign, even without AI intake. Patients who miss their follow up date receive up to two SMS reminders automatically.",
    featureGate: null,
    mapsToDemoStep: 4,
  },
  {
