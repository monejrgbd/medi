  ...
  return (
    <div className="min-h-screen bg-snow flex flex-col">
      ...
      <div className="flex-1 overflow-hidden relative" style={{ zoom: contentZoom }}>
        ...
        >
          <div className="mx-4 mt-4 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 text-center">
            You can also share a check in link with patients before they arrive. They fill out intake from home and skip the approval step.
          </div>
