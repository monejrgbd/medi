          ...
          <div className="hidden items-center gap-3 sm:flex">
            ...
            {!isLoggedIn && (
              <>
                ...
                <Link
                  href="/start-trial"
                  className="inline-flex items-center rounded-lg bg-hilt-blue px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-hilt-blue-dark hover:shadow"
                >
                  Start Trial
                </Link>
              </>
            ...
            {!isLoggedIn && (
              <>
                <a
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-green-600 text-green-700 transition-colors hover:bg-green-50"
                >
                ...
                <Link
                  href="/start-trial"
                  className="inline-flex items-center rounded-lg bg-hilt-blue px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-hilt-blue-dark"
                >
                  Start trial
                </Link>
              </>
