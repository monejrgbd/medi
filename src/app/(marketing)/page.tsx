  ...
  return (
    <section className="cv-auto bg-snow pt-32 pb-10 lg:pt-40 lg:pb-12">
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        {/* Partner badge */}
        <FadeIn>
          <div className="mt-5 flex items-center justify-center gap-2 text-[11px] text-ash">
            <span>Partnered with</span>
            <a
              href="https://ravenscheduler.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 font-medium text-ink hover:text-hilt-blue transition-colors"
            >
            ...
            <span>AI phone receptionist for clinics</span>
          </div>
        </FadeIn>
      </div>
    </section>
