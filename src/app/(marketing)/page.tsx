...
function TrustAndControlSection() {
  ...
  const controls = [
    ...
    {
      title: "AI never tells patients a diagnosis",
      desc: "Patients only see the intake conversation. Suggested differentials and clinical notes go straight to the doctor.",
